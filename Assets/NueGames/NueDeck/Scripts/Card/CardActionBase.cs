...
namespace NueGames.NueDeck.Scripts.Card
{
    public class CardActionParameters
    {
        ...
        public readonly string StrParam;
        public CardActionParameters(float value,CharacterBase target, CharacterBase self,CardData cardData, CardBase cardBase, string strParam)
        {
            Value = value;
